...
module.exports = {
    commandInfo: {
        name: "claimvbucks",
        description: "Claim your daily 100 V-Bucks"
    },
    async execute(interaction) {
        try {
            ...
            await Profiles.findOneAndUpdate(
                ...
                {
                    $inc: { 'profiles.common_core.items.Currency:MtxPurchased.quantity': 100 }, //100 is vbucks for day but u can change it
            ...
            const embed = new MessageEmbed()
                ...
                .setDescription(`You have claimed your daily **100 V-Bucks**!`)
